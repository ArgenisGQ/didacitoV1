...
urlpatterns = [
    ...
    path('admin/clear-embeddings/', views.clear_embeddings, name='clear_embeddings'),
    path('admin/clear-contexts/', views.clear_contexts, name='clear_contexts'),
    path('admin/sync-all-syllabuses/', views.sync_all_syllabuses, name='sync_all_syllabuses'),
